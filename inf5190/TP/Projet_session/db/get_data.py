# script qui crée la bd au début
import requests
import csv
import sqlite3
import datetime
...
insert = "insert into contrevenant (id_poursuite,business_id,date," \
